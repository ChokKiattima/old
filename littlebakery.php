...
<html lang="th">
  ...
  <body>
    ...
    <nav class="nav-menu">
      ...
      <button>
        <h3><a href="promotion.php">Promotion</a></h3>
      </button>
      <button>
        <h3><a href="pound.php">Pound Cake</a></h3>
      </button>
      <button>
        <h3><a href="ice.php">Ice Cream Cake</a></h3>
      </button>
      <button>
        <h3><a href="pricecake.php">Piece of cake</a></h3>
      </button>
      <button>
        <h3><a href="bakery.php">Bakery</a></h3>
      </button>
      <button>
        <h3><a href="member.php">Member</a></h3>
      </button>
    </nav>
    ...
    <div class="cake-section">
      <div class="section-title">
        <h2>Pound cake</h2>
        <a href="pound.php">ดูทั้งหมด →</a>
      </div>
      <div class="cake-grid">
        <div class="cake-item" data-name="Black Forest cake" data-price="500" id ="1">
          <img
          ...
          <button class="detell" onclick="or('#', 0)">
            <a href="bf.php">ดูรายละเอียด</a>
          </button>
        </div>
        <div class="cake-item" data-name="Strawberry Cake" data-price="550" id="2">
          <img
          ...
          <button class="detell" onclick="or('#', 0)">
            <a href="strawberry.php">ดูรายละเอียด</a>
          </button>
        </div>
        <div class="cake-item" data-name="Red Velvet Cake" data-price="600" id="3">
          <img
          ...
          <button class="detell" onclick="or('#', 0)">
            <a href="redv.php">ดูรายละเอียด</a>
          </button>
        </div>
        <div class="cake-item" data-name="Vanilla Cake" data-price="350" id="4">
          <img
          ...
          <button class="detell" onclick="or('#', 0)">
            <a href="valila.php">ดูรายละเอียด</a>
          </button>
        </div>
        <div class="cake-item" data-name="CoCO Cake" data-price="300" id="5">
          <img
          ...
          <button class="detell" onclick="or('#', 0)">
            <a href="coco.php">ดูรายละเอียด</a>
          </button>
        </div>
        <div class="cake-item" data-name="Orange Cake" data-price="300" id="6">
          <img
          ...
          <button class="detell" onclick="or('#', 0)">
            <a href="orange.php">ดูรายละเอียด</a>
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="cake-section">
      <div class="section-title">
        ...
        <a href="ice.php">ดูทั้งหมด →</a>
      </div>
      <div class="cake-grid">
        <div class="cake-item" data-name="orio" data-price="550" id="9">
          <img
          ...
          <div class="cake-details">
            ...
            <button
              class="order-btn"
              onclick="addToCart('Orio Ice Cream ', 550, 'https://img.wongnai.com/p/400x0/2019/08/10/1b388707e24a42228efcb4a7cd29a94a.jpg')"
            >
              ใส่ตะกร้า
            </button>
          </div>
        ...
        <div class="cake-item" data-name="Ice chock cake" data-price="400" id="10">
          <img
        ...
        <div class="cake-item" data-name="Strawberry ic Cake" data-price="600"id="11">
          <img
        ...
        <div class="cake-item" data-name="Fruits  Cake" data-price="350" id="12">
          <img
        ...
        <div class="cake-item" data-name="ChaCha  Cake" data-price="850" id="13">
          <img
        ...
        <div class="cake-item" data-name="Almond  Cake" data-price="700" id="14">
          <img
    ...
    const existingItem = cart.find(item => item.Name_product === name);
